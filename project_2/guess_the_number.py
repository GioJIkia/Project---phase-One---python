...
def guess_the_number(step, remaining_guesses, history):
    while True:
        try:
            ...
            user_input = input(
                f"ცდა {step}, დარჩენილი გაქვთ {remaining_guesses} მცდელობა, გამოიცანი ჩაფიქრებული მთელი რიცხვი 1-დან 100-მდე: "
            )
            print(
                "==========================================================================================="
            )
            ...
            if not user_input.strip():
                print(
                    "შეცდომა, ველი ცარიელია, გთხოვთ შეიყვანოთ მთელი რიცხვი 1-დან 100-მდე!"
                )
                print()
                continue
            ...
            if number_value in history:
                print(
                    f"შეცდომა, რიცხვი {number_value} უკვე შეიყვანეთ ადრე! იყავით ყურადღებით! მცდელობა არ დაგაკლდებათ!"
                )
                print()
                continue
...
def play_game():
    ...
    while i <= total_guesses:
        ...
        if guess == secret_number:
            print(
                f"გილოცავთ,თქვენ გამოიცანით რიცხვი! ჩაფიქრებული რიცხვი იყო {secret_number}!"
            )
            print()
            ...
            print(
                "თქვენს მიერ შეყვანილი რიცხვი მეტია ჩაფიქრებულ რიცხვზე, გთხოვთ შეიყვანოთ უფრო ნაკლები რიცხვი!"
            )
            print()
        else:
            print(
                "თქვენს მიერ თქვენს მიერ შეყვანილი რიცხვი ნაკლებია ჩაფიქრებულ რიცხვზე, გთხოვთ შეიყვანოთ უფრო მეტი რიცხვი"
            )
            print()
