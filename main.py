...
# calculator.py ფაილში ჩაწერა მთელი იმ კოდს, რაც მოთავსებულია სამმაგ ბრჭყალებში
...
# აპლიკაციის გამოყენებისას უზრუნველყოფილი უნდა იყოს შეყვანის სათანადო ვალიდაცია და შეცდომების დამუშავება.
...
# • ბანკომატის ფუნქცია ინახავს მომხმარებლის ანგარიშის მონაცემებს ტექსტურ ფაილში.
